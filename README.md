...
- https://tranco-list.eu/ (топ 20 тыс доменов через https://pypi.org/project/tranco/ с фильтрацией по TLD, keywords и базе GeoLite2-Country.mmdb через удачный резолв исключая RU домены.)
