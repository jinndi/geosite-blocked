...
- https://tranco-list.eu/ (топ 50 тыс доменов через https://pypi.org/project/tranco/ с фильтрацией по TLD, keywords и базе GeoLite2-Country.mmdb через резолв исключая RU/BY/KZ домены.)
